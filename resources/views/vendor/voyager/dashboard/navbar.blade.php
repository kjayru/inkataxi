<nav class="navbar navbar-default navbar-fixed-top navbar-top">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav @if (config('voyager.multilingual.rtl')) navbar-left @else navbar-right @endif">
                <li><a href="/admin/servicio-panico/clientes" class="alertas"><i class="fas fa-bell"></i> <span>{{ @$alertas }}</span></a></li>
                <li class="dropdown profile">
                    <a href="#" class="dropdown-toggle text-right" id="botonscroll" data-toggle="dropdown" role="button"
                       aria-expanded="false"><img src="{{ $user_avatar }}" class="profile-img"> <span
                                class="caret"></span></a>
                    <ul class="dropdown-menu dropdown-menu-animated " id="scrollbox">
