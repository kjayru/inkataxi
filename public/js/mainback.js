...
//modelo-delete
    ...
    let btnses = document.getElementById("botonscroll");
    let boxi = document.getElementById("scrollbox");
    if(btnses){
        btnses.addEventListener('click',function(e){
            boxi.style.display = 'block';
            boxi.style.visibility = 'visible';
            boxi.style.opacity= 1;
            boxi.style.position = 'absolute !important';
        });
